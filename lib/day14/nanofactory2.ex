defmodule Day14.Nanofactory2 do
  @doc """
      iex> Day14.Nanofactory2.part2("day14.txt")
      1000000000000

      # iex> Day14.Nanofactory2.part2("day14-sample2.txt")
      # 82892753
      # iex> Day14.Nanofactory2.part2("day14-sample3.txt")
      # 5586022
      # iex> Day14.Nanofactory2.part2("day14-sample4.txt")
      # 460664
      # iex> Day14.Nanofactory2.part2("day14.txt")
      # 0
  """
  ...
  @doc """
      iex> Day14.Nanofactory2.parse_input_into_recipe_tree("day14-sample1.txt")
  ...
  @doc """
      iex> Day14.Nanofactory2.parse_recipe_output("2 A")
      {"A", 2}
  """
  ...
  @doc """
      iex> Day14.Nanofactory2.parse_recipe_inputs("3 A, 4 B")
      [{"A", 3}, {"B", 4}]
  """
  ...
  @doc """
      # iex> Day14.Nanofactory2.find_lowest_cost(%{"FUEL" => [{1, [{"ORE", 123}]}]})
      # 123
      # iex> Day14.Nanofactory2.find_lowest_cost(%{"FUEL" => [{1, [{"ORE", 123}]}, {1, [{"ORE", 234}]}]})
      # 123
      # iex> Day14.Nanofactory2.find_lowest_cost(%{"FUEL" => [{1, [{"A", 2}]}], "A" => [{1, [{"ORE", 2}]}]})
      # 4
      # iex> Day14.Nanofactory2.find_lowest_cost(%{"FUEL" => [{1, [{"A", 2}, {"B", 1}]}], "A" => [{1, [{"ORE", 2}]}], "B" => [{1, [{"ORE", 3}]}]})
      # 7
      # iex> Day14.Nanofactory2.find_lowest_cost(%{"FUEL" => [{1, [{"A", 7}, {"C", 1}]}], "A" => [{10, [{"ORE", 10}]}], "B" => [{1, [{"ORE", 1}]}], "C" => [{1, [{"A", 7}, {"B", 1}]}]})
      # 21
  """
  def find_lowest_cost(master_recipe_tree, requirements \\ [{"FUEL", 2_690_795}], stock \\ %{})
  ...
  @doc """
      iex> Day14.Nanofactory2.recipe_with_multiplier({2, [{"ORE", 9}]}, 4)
      {2, {2, [{"ORE", 9}]}}
      iex> Day14.Nanofactory2.recipe_with_multiplier({10, [{"ORE", 10}]}, 14)
      {2, {10, [{"ORE", 10}]}}
  """
  ...
  @doc """
      iex> Day14.Nanofactory2.combine_requirements([{"A", 2}], [{"A", 3}])
      [{"A", 5}]
  """
